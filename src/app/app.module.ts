...
import { RegWindowComponent } from './layout/header/top-head/reg-window/reg-window.component';
import {UserMenuComponent} from "./layout/header/top-head/user-menu/user-menu.component";
